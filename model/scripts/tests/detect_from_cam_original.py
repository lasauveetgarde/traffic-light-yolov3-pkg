...
from model.scripts.models import *  # set ONNX_EXPORT in models.py
...
def detect(save_img=False):
    ...
    webcam = source == '6' or '0' or source.startswith('rtsp') or source.startswith('http') or source.endswith('.txt')
    ...
    if webcam:
        ...
        # dataset_iterator = [path, img, im0s, vid_cap]
    else:
        save_img = True
        dataset = LoadImages(source, img_size=imgsz)
        # dataset_iterator = np.zeros(6)
